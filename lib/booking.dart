        ...
        body: Padding(
          ...
          child: Container(
            ...
            child: SingleChildScrollView(
                child: Column(
                    ...
                    children: [
                      ...
                      StreamBuilder<QuerySnapshot>(
                          ...
                          where("id",isEqualTo: currentUserid).snapshots(),
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              ...
                              children: [
                                data!.isEmpty?SizedBox(): Text("Currently actived",
                      ...
                      StreamBuilder<QuerySnapshot>(
                          stream: FirebaseFirestore.instance.collection("booking").where("status",isEqualTo: "reject").
                          where("id",isEqualTo: currentUserid).snapshots(),
                          builder: (context, snapshot) {
                            if(!snapshot.hasData){
                              return Center(child: CircularProgressIndicator(),);
                ...
                StreamBuilder<QuerySnapshot>(
                    stream: FirebaseFirestore.instance.collection("booking").where("status",isEqualTo: "serviced").
                    where("id",isEqualTo: currentUserid).snapshots(),
                    builder: (context, snapshot) {
                      if(!snapshot.hasData){
                        return Center(child: CircularProgressIndicator(),);
